...
public enum TileType {
	...
	ICEBLOCK, JEWEL, OPENSPACE, PUDDLE, 
	STONEBLOCK, WOODBLOCK, TURTLE;
	...
	public Tile createTile(Location location){
		switch (this){
		case OPENSPACE: tile = new OpenSpaceTile(location);
						break;
		case STONEBLOCK: tile = new StoneBlockTile(location);
						break;
		case WOODBLOCK: tile = new WoodBlockTile(location);
						break;
		case ICEBLOCK: tile = new IceBlockTile(location);
						break;
		default:
			break;
		}
